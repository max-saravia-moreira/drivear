...
BEGIN TRY
    ...
    /* --------------------------------------------------------
       2) Usuarios: 5 pasajeros y 5 choferes
          (los IDs se consultarán por email más adelante)
       -------------------------------------------------------- */
    INSERT INTO usuarios
    (cuit_cuil,nombre,apellido,email,telefono,calle,altura,codigo_postal,
    ...
    /* --------------------------------------------------------
       4) Vehículos: asignados a choferes (usuario_id por email)
       -------------------------------------------------------- */
    ...
    /* --------------------------------------------------------
       5) Seguros: uno por vehículo (vehiculo_id por patente)
       -------------------------------------------------------- */
    ...
    /* --------------------------------------------------------
       7) Viajes: referencian vehículos (vehiculo_id por patente)
       -------------------------------------------------------- */
    INSERT INTO viajes
    ...
    /* --------------------------------------------------------
       8) Usuarios_Viajes_Tarjetas:
          ...
          - Viaje por combinación (fecha,origen,destino,hora_inicial)
          - Tarjeta por número
       -------------------------------------------------------- */
    ...
    ( (SELECT usuario_id FROM usuarios WHERE email='carlos@drivear.com'),
      ...
      (SELECT tarjeta_id FROM tarjetas WHERE numero_tarjeta=4111111111111001) ),
    ...
    ( (SELECT usuario_id FROM usuarios WHERE email='mariana@drivear.com'),
      ...
      (SELECT tarjeta_id FROM tarjetas WHERE numero_tarjeta=5555555555552002) ),
    ...
    ( (SELECT usuario_id FROM usuarios WHERE email='sergio@drivear.com'),
      ...
      (SELECT tarjeta_id FROM tarjetas WHERE numero_tarjeta=4111111111113003) ),
    ...
    ( (SELECT usuario_id FROM usuarios WHERE email='andres@drivear.com'),
      ...
      (SELECT tarjeta_id FROM tarjetas WHERE numero_tarjeta=5555555555554004) ),
    ...
    ( (SELECT usuario_id FROM usuarios WHERE email='leonardo@drivear.com'),
      ...
      (SELECT tarjeta_id FROM tarjetas WHERE numero_tarjeta=4111111111115005) ),
    ...
    ( (SELECT usuario_id FROM usuarios WHERE email='carlos@drivear.com'),
      ...
      (SELECT tarjeta_id FROM tarjetas WHERE numero_tarjeta=4111111111117007) ),
    ...
    ( (SELECT usuario_id FROM usuarios WHERE email='sergio@drivear.com'),
      ...
      (SELECT tarjeta_id FROM tarjetas WHERE numero_tarjeta=4111111111119009) ),
    ...
    ( (SELECT usuario_id FROM usuarios WHERE email='andres@drivear.com'),
      ...
      (SELECT tarjeta_id FROM tarjetas WHERE numero_tarjeta=5555555555550010) ),
    ...
    ( (SELECT usuario_id FROM usuarios WHERE email='leonardo@drivear.com'),
      ...
      (SELECT tarjeta_id FROM tarjetas WHERE numero_tarjeta=5555555555556006) );
