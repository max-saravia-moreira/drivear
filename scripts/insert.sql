...
('Federacion Patronal','Terceros',900006,DATEADD(MONTH,8,GETDATE()),'B�sica',6),
...
('Mapfre','Terceros',900010,DATEADD(MONTH,16,GETDATE()),'B�sica+Incendio',10);
...
VALUES
(4111111111111001,'Ramon Lucci','credito','Banco Naci�n','Visa',123,DATEADD(YEAR,2,GETDATE()),@p1),
...
(4111111111119009,'Clara Diaz','credito','Banco Naci�n','Visa',999,DATEADD(YEAR,3,GETDATE()),@p4),
